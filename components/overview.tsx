...
const Overview = () => {
  ...
  return (
    <div className="font-[family-name:var(--font-geist-sans)] max-w-3xl mx-auto p-6">
      ...
      <p className="mb-4">
        ...
        be. We've tried something different; this version is an attempt to speak
          ...
          {section.id === "why" && (
            <>
              ...
              <p className="mb-4">
                ...
                tell potential customers, 'Don't worry too much about all the
                complexities of running your node — just connect to our APIs,
                we'll handle it and you'll have full control over it.' It's been
                an incredible journey, and partnering with companies like
                Coinbase and Nubank while watching payment volume grow has been
                nothing short of magical. Realistically speaking, Lightning has
                been for onboarding the largest custodians.
              </p>
              <p className="mb-4">
                However, the more we were moving forward, the more we were faced
                with the limitations of Lightning's current design, particularly
                when it came to scaling the number of nodes on the network.
              </p>
              <p className="mb-4">
                ...
                experience was just terrible; if you didn't have at least $1,000
                to put into Lightning, it was very difficult to justify those
                costs for the sake of performance. To our credit (or not), we
                tried launching this product at the worst possible time, right
                when the BRC-20/Ordinals surge exploded on L1, unpredictably
                clogging the mempool. Ultimately, we had no choice but to pull
              ...
              <p className="mb-4">
                This issue isn't unique to Lightspark at all. Anyone building on
                the Lightning Network quickly faces the same limitations. A lot
                of very talented companies (Breez, Greenlight, Phoenix, etc.)
                and builders are working hard to find ways to mitigate these
                issues.
              </p>
              <p className="mb-4">
          ...
          {section.id === "how-it-works" && (
            <>
              ...
              <p className="mb-4">
                ...
                we've gone through the same process ourselves, we'll take the
                time to explain each concept, making it as clear and enjoyable
                to read as possible. This section is still relatively
              ...
              <p className="mb-4">
                ...
                denoted by UTXOs (Bitcoin a user hasn't spent yet). In Spark,
                the user sends UTXO's to a multisig between the user and the
                Spark operators (SOs). When a user wants to transfer ownership
                of these funds the Spark operators coordinate and adjust their
                keys so the new owner takes control. The beauty of this is that
                at every moment the user remains in full control of their funds
                and can exit at any time without needing permission from the
                SOs.
              </p>
              <p className="mb-4">
                ...
                anything we're writing; it helps to know who's doing what and
              ...
              <ul className="list-disc list-inside mb-8">
                ...
                <li>
                  ...
                  Lightning. If you don't want to trust a provider, you can also
                  be your own SSP. Some entities will likely be incentivized by
                  charging a small fee for their services. Lightspark is
                ...
                <li>
                  ...
                  for now). Who are these operators? To be honest, we don't know
                  yet. For security reasons, it's unlikely to be open to just
                  anyone, but we aim to keep it as open as possible. We are
                  thinking about the most legitimate and neutral companies or
                  organizations in tech, crypto, academia, etc. If you're
              ...
              <p className="mb-4">
                Now that you're familiar with the key terms, we can dive into
                Spark and see how everything comes together. As mentioned
              ...
              <p className="mb-4">
                ...
                birthday last year. It's been sleeping in your wallet since. You
                keep hearing about the Lightning network and want to play with
                it. You decide to use Spark to keep self-custody but you're
              ...
              <p className="mb-4">
                ...
                transaction they can use to unilaterally exit. It's impossible
                for the SOs to move the money without your signed permission.
              </p>
              ...
              <p className="mb-4">
                ...
                smaller portions of leaves as needed. For example, let's say you
                deposited all the 10 BTC into Spark. If you wanted to send 5 BTC
                on Spark, you'd first split the 10 BTC into two smaller leaves
                (5 BTC each), and then transfer one away. You can split and
                transfer at the same time for efficiency and performance.
              </p>
                ...
                <li>
                  ...
                  <ul className="list-disc list-inside ml-4">
                    <li>
                      ...
                      unlock a Lightning payment) for some of the SSPs' leaves.
                    </li>
                  </ul>
                </li>
              </ul>
              ...
              <p className="mb-4">
                ...
                the functioning Spark. Without them, you can't send or receive
                money on Spark.
              </p>
              <p className="mb-4">
