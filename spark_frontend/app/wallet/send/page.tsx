...
export default function SendPage() {
  ...
  return (
    <div className="font-[family-name:var(--font-decimal)] w-full h-full max-w-md p-4 mb-4 shadow-lg flex flex-col justify-between items-center min-h-[200px] overflow-hidden">
      {isQrScannerOpen ? (
        <div className="fixed inset-0 z-50 h-full w-full flex items-center justify-center bg-[#10151C] bg-opacity-75">
          <div className="relative w-full max-w-md h-full bg-[#10151C] p-4">
            <Button
              variant="ghost"
              size="icon"
            ...
            <QrReader
              ...
              onResult={(result, error) => {
                if (result) {
                  ...
                  setRecipient(scannedText.toString().toLowerCase());
                  handleRecipientChange(scannedText.toString().toLowerCase());
          ...
          <motion.main
            ...
            {step === "to" && (
              <div className="flex flex-col h-full font-sans px-4">
                <div className="relative flex flex-col justify-center items-start p-4 w-full bg-[#121E2D] rounded-lg font-[family-name:var(--font-decimal)]">
                  <Input
                    type="text"
                    value={
                      recipientType === "phone"
            ...
            {step === "summary" && (
              <motion.div
                ...
                <p className="text-sm text-gray-400 mb-6 text-center">
                  We&apos;ll send a text to {recipient} with a link they can
                  open to receive your payment. All they need to do is log in
                  with their phone number to see their wallet.
                </p>
                <SparkButton
